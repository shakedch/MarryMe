                                                ...
                                                <?php if ($list[$i] == 'To Do') : ?>
                                                    ...
                                                    <?php if ($list[$i] == 'In Progress') : ?>
                                                        ...
                                                        <?php if ($list[$i] == 'Completed') : ?>
                                                            ...
                                                            <div class="modal fade" id='taskViewModal<?php echo $row['task_id']; ?>' tabindex="-1" aria-labelledby="taskModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content modalBorder">
                                                                        ...
                                                                        <form id="editForm" action="updateTask.php" method="POST" class="ajax" enctype="multipart/form-data">
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="task_id" value="<?php echo $row['task_id']; ?>">
                                                                                <div class='mb-3 nameDiv'>
                                                                                    <label class="form-label lableTask" for='viewName'>Task
                                                                                        Name</label>
                                                                                    <input class="form-control name inputTask" id="<?php echo $row['task_id']; ?>" type="text" name="viewName" value="<?php echo $row['name']; ?>" placeholder="Enter Task name" disabled>
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    <label for="start_date" class="form-label lableTask ">Start
                                                                                        Date</label>
                                                                                    <input class="form-control inputTask" type="datetime-local" name="start_date" value="<?php echo str_replace(' ', 'T', $row['start_date']); ?>" disabled onchange="getStartDateTask(this.value)">
                                                                                </div>

                                                                                <div class="mb-3">
                                                                                    <label for="due_date" class="form-label lableTask">Due
                                                                                        Date</label>
                                                                                    <input class="form-control inputTask" type="datetime-local" name="due_date" id='due_date' value="<?php echo str_replace(' ', 'T', $row['due_date']); ?>" disabled>
                                                                                </div>
                                                                                <div class='mb-3'>
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <textarea class="form-control descriptionTask" name="description" rows="3" disabled><?php echo $row['description']; ?></textarea>
                                                                                </div>
                                                                                <select name='status' class="form-select statusTask lableTask" disabled aria-label="Default select example">
                                        ...
                                        <form name="createForm" id="createForm" action="insertAndDelete.php" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <div class='mb-3 '>
                                                    ...
                                                    <input class="form-control inputTask" type="datetime-local" name="start_date" value="<?php echo date('Y-m-d\TH:i'); ?>" onchange="getStartDateTask(this.value)">
                                                </div>
                                                ...
                                                <div class="mb-3 form-group">
                                                    <select id="statusCreate" name='status' class="form-select statusTask lableTask" aria-label="Default select example">
