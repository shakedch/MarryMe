    ...
    <div class="wrapper">
        ...
        <div>
            <div class="addTaskBtnWrapper">
                <button type="button" class="m-md-5 addTaskBtn" name="newTask" data-bs-toggle="modal"
                    data-bs-target="#taskCreateModal"><i class="bi bi-plus addIcon"></i>Add
                    New Task</button>
            </div>
            ...
            <div class="d-flex justify-content-around col-md-12">
                ...
                <div class="card cardLists col-md-4 p-2">
                            ...
                            <div class="card-body cardBodyScroll">
                                ...
                                <div class="card mb-3 mt-3" style="border:2.3px solid #E47F74;">
                                    ...
                                    <div class="card mb-3 mt-3" style="border:2.3px solid #EFA37E;">
                                        ...
                                        <div class="card mb-3 mt-3" style="border:2.3px solid #9BAD69;">
                                            ...
                                            <div class="card-footer" style="background-color:white;">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <button class="btn information" data-bs-toggle="modal"
                                                        data-bs-target="#taskViewModal<?php echo $row['task_id']; ?>">
                                                        <i class="far fa-eye fa-lg information" style="color:#70bdf2">
                                                        </i>
                                                    </button>
                                                    <button class="btn" name="delete" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal<?php echo $row['task_id']; ?>">
                                                        <i class="fas fa-trash fa-lg"
                                                            style="color:#b12531"></i></button>
                                        ...
                                        <div class="modal fade" id='taskViewModal<?php echo $row['task_id']; ?>'
                                                    ...
                                                    <form id="editForm" action="updateTask.php" method="POST"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class='mb-3 nameDiv'>
                                                                <label class="form-label lableTask" for='name'>Task
                                                                    Name</label>
                                                                <input class="form-control name inputTask"
                                                                    id="<?php echo $row['task_id']; ?>" type="text"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a id="edit"
                                                                href="tasks.php?edit=<?php echo $row['task_id']; ?>"
                                                                data-task-id="<?php echo $row['task_id']; ?>"
                                                                value="edit" class="btn btnEdit edit">Edit</a>

                                                            <button type="submit"
                                                                class="btn btnUpdate updatetask">Update</button>
                                        ...
                                        <div class="modal fade" id="deleteModal<?php echo $row['task_id']; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content modalBorder">
                                                    ...
                                                    <form action="insertAndDelete.php" method="POST"
                                                        ...
                                                        <div class="modal-footer deletefooter">
                                                            ...
                                                            <a id="deleteTask" name="deleteTask"
                                                                ...
                                                                data-task-id="<?php echo $row['task_id']; ?>"
                                                                value="deleteTask" class="btn btnYes deleteTask">Yes</a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <div class="modal fade" id='taskCreateModal' tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content modalBorder">
                                <div class="modal-header">
                                ...
                                <form name="createForm" id="createForm" action="insertAndDelete.php" method="POST"
                                    enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <input type="hidden" name="task_id">
                                        ...
                                        <div class='mb-3 form-group '>
                                            ...
                                            <input class="form-control inputTask" type="datetime-local" name="due_date"
                                                id='due_date' value="<?php echo date('Y-m-d\TH:i'); ?>">
                                            <i class="fas fa-check-circle"></i>
                                            <i class="fas fa-exclamation-circle"></i>
                                        ...
                                        <div class='mb-3 form-group'>
                                            ...
                                            <input class="form-control inputTask" id="createCost" type="text" value=0
