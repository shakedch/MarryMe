        ...
        <div>
            ...
            <div class="d-flex justify-content-around col-md-12">
                ...
                <div class="card cardLists col-md-4 p-2">
                    ...
                    <div class="modal fade" id='taskCreateModal' data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content modalBorder">
                                <div class="modal-header">
                                    ...
                                    <button onclick="changeClass()" type="button" class="btn-close"
                                ...
                                <form name="createForm" id="createForm" action="insertAndDelete.php" method="POST"
                                    ...
                                    <div class="modal-footer">
                                        <button onclick="changeClass()" type="button" class="btn closeBtn"
                                            data-bs-dismiss="modal">Close</button>
