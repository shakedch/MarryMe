    ...
    ?>
            ...
            <div class="userInfoWrapper">
                <div class="panel-body inf-content">
                    <div class="row">
                        <div class="col-md-5">
                            <img class="imgProfile" alt="" title="" class="img-circle img-thumbnail isTooltip" src="../../assets/img/hp_img_two.jpg" data-original-title="Usuario">
                        </div>
                        <div class="col-md-6">
        ...
        ?>
            ...
            <div class="userInfoWrapper">
                <div class="panel-body inf-content">
                    <div class="row">
                        <div class="col-md-5">
                            <img alt="" class="imgProfile" title="" class="img-circle img-thumbnail isTooltip" src="../../assets/img/myAccountVendor.jpg" data-original-title="Usuario">
                        </div>
                        <div class="col-md-6">
                            <strong>Information</strong><br>
                            <div class="table-responsive">
