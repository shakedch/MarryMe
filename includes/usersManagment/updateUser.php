                        ...
                        <div class="card-body">
                            ...
                            <form method="post">
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Update first full name" name="full_name1" value="<?php echo $userDetails->full_name1; ?>">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" value="<?php echo $userDetails->full_name2; ?>" placeholder="Update second full name" name="full_name2">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="date" value="<?php echo ($userDetails->date_of_wedding); ?>" placeholder="Update Wedding Date" name="date_of_wedding">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="time" value="<?php echo $userDetails->hour_of_wedding; ?>" placeholder="Update hour of wedding" name="hour_of_wedding">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" value="<?php echo $userDetails->budget; ?>" placeholder="Update your budget" name="budget">
                                </div>
                                <p id="error"><?php echo $error ?></p>
                                <input class="btn btn-block registerForm-btn mb-4" type="submit" name="submit" value="Update">
                            </form>
                        </div>
                    </div>
                </div>
